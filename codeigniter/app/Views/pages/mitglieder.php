                ...
                <tr>
                    ...
                    <td>
                        <div class="container d-flex justify-content-end">
                            <form action="<?= base_url('Mitglieder/mitglieder_edit')?>" method="post">
                            ...
                            <form action="<?= base_url('Mitglieder/mitglieder_delete')?>" method="post">
                                <button class="table-button" name="<?php echo $member['id_mitglieder']; ?>_delete" id="<?php echo $member['id_mitglieder']; ?>_delete">
