        ...
        <table class="table">
            ...
            foreach($members as $member){
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" disabled id="<?php echo $member['id']; ?>_status" <?php if(array_search($_SESSION['project'], $member['projects']) !== false){ echo 'checked'; }?>>
                    </td>
                    <td>
                        <div class="container d-flex justify-content-end">
                            <button class="table-button" id="<?php echo $member['id']; ?>_edit" class="reiter-button">
                            ...
                            <button class="table-button" id="<?php echo $member['id']; ?>_delete">
